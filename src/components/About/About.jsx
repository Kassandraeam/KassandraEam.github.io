                ...
                <div className='flex flex-col'>
                    ...
                    <div className='m-5'>
                        ...
                        <div className='animate__slideInRight'>
                            <div className='flex flex-col'>
                                <p>You already know my name and what I'm <span className='text-indigo-600'>passionate</span> about, so I'll tell you about some of the <span className='text-indigo-600'>technologies</span> I've been using:</p>
